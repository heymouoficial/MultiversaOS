...
export const t = {
  es: {
    ...
    hero: {
      spots: "10 SPOTS",
      h1: "Tu Web Inteligente",
      h2: "Trabajando Para Ti.",
      p: "Despliega tu presencia digital en el Multiverso.",
      powered: "Powered by Gemini 3.0 & Vercel Edge.",
      input: "Háblanos de tu negocio (ej: Vendo café de especialidad)...",
      button: "CONSULTORÍA GRATUITA",
      analyzing: "GENERANDO BLUEPRINT...",
    ...
    stack: {
      title: "Arquitectura",
      subtitle: "Stack transparente. Rendimiento nativo.",
      desc1: "Core Framework",
      desc2: "Data Layer",
      desc3: "Edge Network",
      desc4: "Neural Engine"
    },
    ...
    chat: {
      ...
      powered: "Multiversa Intelligence • Gemini 3.0",
      triggers: {
        what: "¿Qué es Multiversa?",
        options: "Opciones y Precios",
  ...
  en: {
    ...
    hero: {
      spots: "10 SPOTS",
      h1: "Your Intelligent Web",
      h2: "Working For You.",
      p: "Deploy your digital presence in the Multiverse.",
      powered: "Powered by Gemini 3.0 & Vercel Edge.",
      input: "Tell us about your business (e.g. Specialty Coffee Shop)...",
      button: "FREE CONSULTING",
      analyzing: "GENERATING BLUEPRINT...",
    ...
    stack: {
      title: "Architecture",
      subtitle: "Transparent stack. Native performance.",
      desc1: "Core Framework",
      desc2: "Data Layer",
      desc3: "Edge Network",
      desc4: "Neural Engine"
