...
const FinalCTA: React.FC<FinalCTAProps> = ({ text, onAction }) => {
  return (
    <div className="w-full py-24 px-4 text-center relative overflow-hidden flex flex-col items-center justify-center">
        ...
        {/* Ambient Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-lime-neon/5 blur-[120px] pointer-events-none rounded-full"></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12">
                ...
                <button 
                    onClick={onAction}
                    className="px-10 py-5 bg-lime-neon text-black text-sm font-bold uppercase tracking-widest rounded-xl hover:bg-lime-400 transition-all w-full sm:w-auto shadow-[0_0_40px_rgba(190,242,100,0.4)] btn-shine"
                >
                    SmartWeb ($400)
                </button>
            </div>
             ...
             <div className="mt-16">
                <button onClick={onAction} className="text-zinc-500 dark:text-zinc-600 hover:text-lime-600 dark:hover:text-lime-neon text-[10px] uppercase tracking-[0.3em] font-normal transition-colors border-b border-transparent hover:border-lime-600 dark:hover:border-lime-neon pb-1">
                    {text.whatsapp}
                </button>
             </div>
        </div>
