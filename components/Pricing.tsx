    ...
    <div className="w-full h-full flex flex-col justify-center items-center px-4 relative py-20 md:py-0">
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-end">
            {/* NanoWeb */}
            <div className="glass-cinematic p-8 rounded-3xl flex flex-col h-[480px] relative group bg-white/60 dark:bg-onyx/40 border border-black/5 dark:border-white/5 transition-colors duration-500">
                <div className="mb-4">
                ...
                <div className="pt-6 border-t border-black/5 dark:border-white/5 w-full">
                    <div className="flex justify-between items-baseline mb-4">
                        <span className="text-zinc-400 text-xs tracking-widest uppercase">Investment</span>
            ...
            <div className="glow-border-container p-[1px] h-[540px] flex flex-col relative group">
                <div className="bg-white/90 dark:bg-onyx/90 backdrop-blur-xl rounded-xl w-full h-full p-8 flex flex-col relative overflow-hidden transition-colors duration-500 border border-spring-neon/30 dark:border-spring-neon/30">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="w-10 h-0.5 bg-spring-dim dark:bg-spring-neon mt-2"></div>
                    </div>
                    ...
                    <ul className="space-y-3 mb-auto text-xs text-zinc-500 dark:text-zinc-400 font-mono">
                        <li className="flex items-center gap-3"><span className="text-spring-text dark:text-spring-neon">✓</span> Astro + React Engine</li>
                        <li className="flex items-center gap-3"><span className="text-spring-text dark:text-spring-neon">✓</span> WhatsApp Integration</li>
                        <li className="flex items-center gap-3"><span className="text-spring-text dark:text-spring-neon">✓</span> 36h Delivery</li>
                    </ul>

                    <div className="pt-6 border-t border-black/10 dark:border-white/10 w-full">
                        <div className="flex justify-between items-baseline mb-4">
                            <span className="text-spring-text dark:text-spring-neon font-medium text-xs tracking-widest uppercase">Best Value</span>
                            <span className="text-3xl font-light text-zinc-900 dark:text-white">$400</span>
                        </div>
                        <button 
                             onClick={() => onSelectPlan('SmartWeb')}
                             className="w-full py-3 rounded-xl bg-spring-neon text-black text-xs font-bold uppercase tracking-widest hover:bg-spring-dim hover:text-white transition-colors shadow-[0_0_20px_rgba(0,255,161,0.3)] btn-shine"
                        >
                            Reservar Spot
                        </button>
                    </div>
            ...
            {/* Custom Web (Updated) */}
            <div className="glass-cinematic p-8 rounded-3xl flex flex-col h-[600px] md:h-[540px] relative group bg-white/60 dark:bg-onyx/40 hover:bg-white/80 dark:hover:bg-white/5 border border-black/5 dark:border-white/5 transition-colors duration-500">
                <div className="mb-4">
                ...
                <div className="pt-6 border-t border-black/5 dark:border-white/5 w-full">
                    <div className="flex justify-between items-baseline mb-4">
                        <span className="text-zinc-400 text-xs tracking-widest uppercase">Enterprise</span>
                        <span className="text-xs font-mono text-spring-text dark:text-spring-neon border border-spring-text/20 dark:border-spring-neon/20 px-2 py-1 rounded">CONSULTING</span>
                    </div>
                     <button 
                        onClick={() => onSelectPlan('Custom Web')}
                        className="w-full py-3 rounded-xl bg-transparent border border-black/10 dark:border-white/10 text-xs uppercase tracking-widest text-zinc-600 dark:text-zinc-300 hover:border-spring-dim dark:hover:border-spring-neon hover:text-spring-dim dark:hover:text-spring-neon transition-colors"
                     >
                        {text.soon}
                    </button>
                </div>
