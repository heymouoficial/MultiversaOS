            ...
            <div className="glow-border-container p-[1px] h-[540px] flex flex-col relative group">
                <div className="bg-white/90 dark:bg-black/90 backdrop-blur-xl rounded-xl w-full h-full p-8 flex flex-col relative overflow-hidden transition-colors duration-500">
                    ...
                    <ul className="space-y-3 mb-auto text-xs text-zinc-500 dark:text-zinc-400 font-mono">
                        <li className="flex items-center gap-3"><span className="text-lime-600 dark:text-lime-neon">✓</span> Astro + React Engine</li>
                        <li className="flex items-center gap-3"><span className="text-lime-600 dark:text-lime-neon">✓</span> WhatsApp Integration</li>
                        <li className="flex items-center gap-3"><span className="text-lime-600 dark:text-lime-neon">✓</span> 36h Delivery</li>
                    </ul>

                    <div className="pt-6 border-t border-black/10 dark:border-white/10 w-full">
                        <div className="flex justify-between items-baseline mb-4">
                            <span className="text-lime-600 dark:text-lime-neon font-medium text-xs tracking-widest uppercase">Best Value</span>
