    ...
    <div className="w-full h-full flex flex-col justify-center items-center px-4 relative py-20 pb-32 md:pb-20">
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-12 animate-reveal">
            ...
            <div className="inline-block bg-spring-neon text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest animate-pulse">
                {text.subtitle}
            </div>
        </div>

        {/* BLUEPRINT NOTICE */}
        <div className="max-w-3xl mx-auto mb-12 text-center p-4 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm">
             <span className="text-spring-neon font-mono text-xs uppercase mr-2">{text.blueprintLabel}</span>
             <span className="text-zinc-400 text-xs font-light">{text.blueprintDesc}</span>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch mb-12">
            ...
            <div className="glass-cinematic p-8 rounded-3xl flex flex-col relative group bg-white/[0.02] dark:bg-white/[0.02] border border-white/5 hover:border-spring-neon/30 transition-all duration-500 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]">
                <div className="mb-8 border-b border-white/5 pb-6">
                     <div className="flex justify-between items-center mb-2">
                        ...
                        <div className="flex flex-col items-end">
                            <span className="text-xs text-zinc-500 line-through decoration-red-500 decoration-2">{text.freelancerPriceOriginal}</span>
                            <span className="text-xl font-light text-spring-neon tracking-tight">{text.freelancerPriceDiscount}</span>
                        </div>
                     </div>
                     <h3 className="text-3xl font-bold text-white tracking-tight mt-2">{text.freelancerName}</h3>
                ...
                <div className="pt-6 w-full mt-8">
                    ...
                    <button 
                        onClick={() => onSelectPlan('NanoWeb (30% OFF)')}
                ...
                <div className="bg-[#1A1A1A] backdrop-blur-2xl rounded-xl w-full h-full p-8 flex flex-col relative overflow-hidden transition-colors duration-500 shadow-[0_0_50px_rgba(0,255,161,0.15)]">
                    <div className="absolute top-0 right-0 p-5">
                        <div className="flex items-center gap-2">
                            <span className="text-[9px] font-mono text-spring-neon uppercase tracking-wider animate-pulse">{text.recommended}</span>
                    ...
                    <div className="mb-8 border-b border-white/10 pb-6">
                         <div className="flex justify-between items-center mb-2">
                            <span className="text-[10px] font-mono text-spring-dim bg-spring-neon/10 uppercase tracking-[0.2em] border border-spring-neon/20 px-2 py-1 rounded-md">{text.pymeTag}</span>
                             <div className="flex flex-col items-end">
                                <span className="text-sm text-zinc-500 line-through decoration-red-500 decoration-2">{text.pymePriceOriginal}</span>
                                <div className="bg-spring-neon/10 px-3 py-1 rounded-full border border-spring-neon/20">
                                    <span className="text-2xl font-light text-white tracking-tighter">{text.pymePriceDiscount}</span>
                                </div>
                             </div>
                         </div>
                    ...
                    <div className="pt-6 w-full mt-8">
                        ...
                        <button 
                             onClick={() => onSelectPlan('SmartWeb (30% OFF)')}
            ...
            <div className="glass-cinematic p-8 rounded-3xl flex flex-col relative group bg-white/[0.02] dark:bg-white/[0.02] border border-white/5 transition-colors duration-500 hover:border-white/20">
                ...
                <div className="pt-6 w-full mt-8">
                    <div className="flex justify-between items-baseline mb-4 px-2">
                        <span className="text-zinc-600 text-[10px] tracking-widest uppercase">{text.customTag}</span>
                        <span className="text-[10px] font-mono text-zinc-400 border border-white/10 px-2 py-1 rounded">{text.vipTag}</span>
                    </div>
                     <button 
        ...
        {/* DISCLAIMER PAY AS YOU GO - WRAPPED FIX */}
        <div className="w-full max-w-4xl mx-auto mb-10 px-4">
             <div className="flex flex-col md:flex-row items-center justify-center gap-3 px-6 py-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
                 ...
                 <span className="text-xs text-zinc-300 font-light text-center md:text-left leading-relaxed">{text.disclaimer}</span>
             </div>
        </div>
        ...
        <div className="w-full max-w-6xl mx-auto">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                 ...
                 <div className="glass-cinematic p-5 rounded-2xl border border-white/5 bg-gradient-to-br from-blue-950/20 to-transparent hover:border-blue-500/30 transition-all duration-300 group flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left hover:-translate-y-1">
                     ...
                     <div className="flex-1 min-w-0">
                         <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                             ...
                             <div className="flex items-center gap-2">
                                <span className="text-[10px] text-zinc-500 line-through">{text.addon1PriceOld}</span>
                     ...
                     <button 
                        onClick={() => onSelectPlan(`Add-on: ${text.addon1Title} (Promo)`)}
                  ...
                  <div className="glass-cinematic p-5 rounded-2xl border border-white/5 bg-gradient-to-br from-purple-950/20 to-transparent hover:border-purple-500/30 transition-all duration-300 group flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left hover:-translate-y-1">
                     ...
                     <div className="flex-1 min-w-0">
                         <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                             ...
                             <div className="flex items-center gap-2">
                                <span className="text-[10px] text-zinc-500 line-through">{text.addon2PriceOld}</span>
                     ...
                     <button 
                        onClick={() => onSelectPlan(`Add-on: ${text.addon2Title} (Promo)`)}
                 ...
                 {/* Headless Blog Card (Orange/Amber) */}
                 <div className="glass-cinematic p-5 rounded-2xl border border-white/5 bg-gradient-to-br from-orange-950/20 to-transparent hover:border-orange-500/30 transition-all duration-300 group flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left hover:-translate-y-1">
                     <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-400 shrink-0 border border-orange-500/20 shadow-[0_0_15px_rgba(249,115,22,0.1)] group-hover:scale-105 transition-transform">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                     </div>
                     <div className="flex-1 min-w-0">
                         <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                             <h4 className="text-white font-semibold text-base">{text.addon3Title}</h4>
                             <div className="flex items-center gap-2">
                                <span className="text-[10px] bg-orange-500/10 text-orange-300 px-2 py-0.5 rounded border border-orange-500/20 font-mono">{text.addon3Price}</span>
                             </div>
                         </div>
                         <p className="text-zinc-400 text-xs font-light leading-snug">{text.addon3Desc}</p>
                     </div>
                     <button 
                        onClick={() => onSelectPlan(`Add-on: ${text.addon3Title} (Setup)`)}
                        className="px-5 py-2.5 rounded-lg bg-white/5 hover:bg-orange-600 hover:text-white text-zinc-300 text-[10px] font-bold tracking-widest uppercase transition-all border border-white/10 shrink-0 hover:shadow-[0_0_15px_rgba(249,115,22,0.4)] active:scale-95"
                     >
                        {text.addonBtn}
                     </button>
                 </div>

                 {/* SEO Agent Card (Emerald) */}
                 <div className="glass-cinematic p-5 rounded-2xl border border-white/5 bg-gradient-to-br from-emerald-950/20 to-transparent hover:border-emerald-500/30 transition-all duration-300 group flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left hover:-translate-y-1">
                     <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400 shrink-0 border border-emerald-500/20 shadow-[0_0_15px_rgba(16,185,129,0.1)] group-hover:scale-105 transition-transform">
                     ...
                     <div className="flex-1 min-w-0">
                         <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                             <h4 className="text-white font-semibold text-base">{text.addon4Title}</h4>
                             <div className="flex items-center gap-2">
                                <span className="text-[10px] text-zinc-500 line-through">{text.addon4PriceOld}</span>
                                <span className="text-[10px] bg-emerald-500/10 text-emerald-300 px-2 py-0.5 rounded border border-emerald-500/20 font-mono">{text.addon4Price}</span>
                             </div>
                         </div>
                         <p className="text-zinc-400 text-xs font-light leading-snug">{text.addon4Desc}</p>
                     </div>
                     <button 
                        onClick={() => onSelectPlan(`Add-on: ${text.addon4Title} (Limited)`)}
                        className="px-5 py-2.5 rounded-lg bg-white/5 hover:bg-emerald-600 hover:text-white text-zinc-300 text-[10px] font-bold tracking-widest uppercase transition-all border border-white/10 shrink-0 hover:shadow-[0_0_15px_rgba(16,185,129,0.4)] active:scale-95"
                     >
                        {text.addonBtn}
                     </button>
                 </div>
